...
extern "C" {
::std::size_t cxx_juce$cxxbridge1$190$BoxedAudioIODeviceCallback$operator$sizeof() noexcept;
::std::size_t cxx_juce$cxxbridge1$190$BoxedAudioIODeviceCallback$operator$alignof() noexcept;
} // extern "C"
} // namespace cxx_juce

namespace audio_io_device_callback {
extern "C" {
void audio_io_device_callback$cxxbridge1$190$about_to_start(::cxx_juce::BoxedAudioIODeviceCallback &callback, ::juce::AudioIODevice &device) noexcept;

void audio_io_device_callback$cxxbridge1$190$process_block(::cxx_juce::BoxedAudioIODeviceCallback &callback, ::juce::AudioSampleBuffer const &input, ::juce::AudioSampleBuffer &output) noexcept;

void audio_io_device_callback$cxxbridge1$190$stopped(::cxx_juce::BoxedAudioIODeviceCallback &callback) noexcept;
} // extern "C"
} // namespace audio_io_device_callback

namespace cxx_juce {
extern "C" {
::std::size_t cxx_juce$cxxbridge1$190$BoxedAudioIODeviceType$operator$sizeof() noexcept;
::std::size_t cxx_juce$cxxbridge1$190$BoxedAudioIODeviceType$operator$alignof() noexcept;
} // extern "C"
} // namespace cxx_juce

namespace audio_io_device_type {
extern "C" {
void audio_io_device_type$cxxbridge1$190$name(::cxx_juce::BoxedAudioIODeviceType const &self_, ::rust::String *return$) noexcept;

void audio_io_device_type$cxxbridge1$190$scan_for_devices(::cxx_juce::BoxedAudioIODeviceType &self_) noexcept;

void audio_io_device_type$cxxbridge1$190$get_device_names(::cxx_juce::BoxedAudioIODeviceType const &self_, bool input, ::rust::Vec<::rust::String> *return$) noexcept;

::cxx_juce::BoxedAudioIODevice *audio_io_device_type$cxxbridge1$190$create_device(::cxx_juce::BoxedAudioIODeviceType &self_, ::rust::Str input_device_name, ::rust::Str output_device_name) noexcept;

void audio_io_device_type$cxxbridge1$190$destroy_device(::cxx_juce::BoxedAudioIODevice *self_) noexcept;
} // extern "C"
} // namespace audio_io_device_type

namespace cxx_juce {
extern "C" {
::std::size_t cxx_juce$cxxbridge1$190$BoxedAudioIODevice$operator$sizeof() noexcept;
::std::size_t cxx_juce$cxxbridge1$190$BoxedAudioIODevice$operator$alignof() noexcept;
} // extern "C"
} // namespace cxx_juce

namespace audio_io_device {
extern "C" {
void audio_io_device$cxxbridge1$190$device_name(::cxx_juce::BoxedAudioIODevice const &self_, ::rust::String *return$) noexcept;

void audio_io_device$cxxbridge1$190$device_type_name(::cxx_juce::BoxedAudioIODevice const &self_, ::rust::String *return$) noexcept;

double audio_io_device$cxxbridge1$190$device_sample_rate(::cxx_juce::BoxedAudioIODevice &self_) noexcept;

::std::size_t audio_io_device$cxxbridge1$190$device_buffer_size(::cxx_juce::BoxedAudioIODevice &self_) noexcept;

void audio_io_device$cxxbridge1$190$device_available_sample_rates(::cxx_juce::BoxedAudioIODevice &self_, ::rust::Vec<double> *return$) noexcept;

void audio_io_device$cxxbridge1$190$device_available_buffer_sizes(::cxx_juce::BoxedAudioIODevice &self_, ::rust::Vec<::std::size_t> *return$) noexcept;

void audio_io_device$cxxbridge1$190$device_open(::cxx_juce::BoxedAudioIODevice &self_, double sample_rate, ::std::size_t buffer_size, ::rust::String *return$) noexcept;

void audio_io_device$cxxbridge1$190$device_close(::cxx_juce::BoxedAudioIODevice &self_) noexcept;
} // extern "C"
} // namespace audio_io_device

namespace cxx_juce {
extern "C" {
void cxx_juce$cxxbridge1$190$version(::rust::String *return$) noexcept {
  ::rust::String (*version$)() = ::cxx_juce::juceVersion;
  new (return$) ::rust::String(version$());
}

void cxx_juce$cxxbridge1$190$initialise_juce() noexcept {
  void (*initialise_juce$)() = ::cxx_juce::initialiseJuce;
  initialise_juce$();
}

void cxx_juce$cxxbridge1$190$shutdown_juce() noexcept {
  void (*shutdown_juce$)() = ::cxx_juce::shutdownJuce;
  shutdown_juce$();
}

::std::int32_t cxx_juce$cxxbridge1$190$AudioIODeviceTypeArray$size(::juce::AudioIODeviceTypeArray const &self) noexcept {
  ::std::int32_t (::juce::AudioIODeviceTypeArray::*size$)() const = &::juce::AudioIODeviceTypeArray::size;
  return (self.*size$)();
}

::juce::AudioIODeviceType *cxx_juce$cxxbridge1$190$AudioIODeviceTypeArray$get_unchecked(::juce::AudioIODeviceTypeArray const &self, ::std::int32_t index) noexcept {
...
::cxx_juce::AudioDeviceSetup *cxx_juce$cxxbridge1$190$create_audio_device_setup() noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceSetup$output_device_name(::cxx_juce::AudioDeviceSetup const &self, ::rust::Str *return$) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceSetup$input_device_name(::cxx_juce::AudioDeviceSetup const &self, ::rust::Str *return$) noexcept {
...
double cxx_juce$cxxbridge1$190$AudioDeviceSetup$sample_rate(::cxx_juce::AudioDeviceSetup const &self) noexcept {
  double (::cxx_juce::AudioDeviceSetup::*sample_rate$)() const = &::cxx_juce::AudioDeviceSetup::sampleRate;
  return (self.*sample_rate$)();
}

::std::int32_t cxx_juce$cxxbridge1$190$AudioDeviceSetup$buffer_size(::cxx_juce::AudioDeviceSetup const &self) noexcept {
  ::std::int32_t (::cxx_juce::AudioDeviceSetup::*buffer_size$)() const = &::cxx_juce::AudioDeviceSetup::bufferSize;
  return (self.*buffer_size$)();
}

void cxx_juce$cxxbridge1$190$AudioDeviceSetup$set_output_device_name(::cxx_juce::AudioDeviceSetup &self, ::rust::Str name) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceSetup$set_input_device_name(::cxx_juce::AudioDeviceSetup &self, ::rust::Str name) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceSetup$set_sample_rate(::cxx_juce::AudioDeviceSetup &self, double sample_rate) noexcept {
  void (::cxx_juce::AudioDeviceSetup::*set_sample_rate$)(double) = &::cxx_juce::AudioDeviceSetup::setSampleRate;
  (self.*set_sample_rate$)(sample_rate);
}

void cxx_juce$cxxbridge1$190$AudioDeviceSetup$set_buffer_size(::cxx_juce::AudioDeviceSetup &self, ::std::int32_t buffer_size) noexcept {
  void (::cxx_juce::AudioDeviceSetup::*set_buffer_size$)(::std::int32_t) = &::cxx_juce::AudioDeviceSetup::setBufferSize;
  (self.*set_buffer_size$)(buffer_size);
}

::std::int32_t cxx_juce$cxxbridge1$190$AudioDeviceSetup$number_of_input_channels(::cxx_juce::AudioDeviceSetup const &self) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceSetup$set_number_of_input_channels(::cxx_juce::AudioDeviceSetup &self, ::std::int32_t number_of_input_channels) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceSetup$use_default_input_channels(::cxx_juce::AudioDeviceSetup &self, bool use_default) noexcept {
...
bool cxx_juce$cxxbridge1$190$AudioDeviceSetup$using_default_input_channels(::cxx_juce::AudioDeviceSetup const &self) noexcept {
...
::std::int32_t cxx_juce$cxxbridge1$190$AudioDeviceSetup$number_of_output_channels(::cxx_juce::AudioDeviceSetup const &self) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceSetup$set_number_of_output_channels(::cxx_juce::AudioDeviceSetup &self, ::std::int32_t number_of_output_channels) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceSetup$use_default_output_channels(::cxx_juce::AudioDeviceSetup &self, bool use_default) noexcept {
...
bool cxx_juce$cxxbridge1$190$AudioDeviceSetup$using_default_output_channels(::cxx_juce::AudioDeviceSetup const &self) noexcept {
...
::cxx_juce::AudioDeviceManager *cxx_juce$cxxbridge1$190$create_audio_device_manager() noexcept {
...
::cxx_juce::AudioCallbackWrapper *cxx_juce$cxxbridge1$190$wrap_audio_callback(::cxx_juce::BoxedAudioIODeviceCallback *callback) noexcept {
...
::rust::repr::PtrLen cxx_juce$cxxbridge1$190$AudioDeviceManager$initialise_with_default_devices(::cxx_juce::AudioDeviceManager &self, ::std::int32_t num_input_channels, ::std::int32_t num_output_channels) noexcept {
...
::cxx_juce::AudioDeviceSetup *cxx_juce$cxxbridge1$190$AudioDeviceManager$get_audio_device_setup(::cxx_juce::AudioDeviceManager const &self) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceManager$set_audio_device_setup(::cxx_juce::AudioDeviceManager &self, ::cxx_juce::AudioDeviceSetup const &setup) noexcept {
...
::juce::AudioIODevice *cxx_juce$cxxbridge1$190$AudioDeviceManager$get_current_audio_device(::cxx_juce::AudioDeviceManager const &self) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceManager$get_available_device_types(::cxx_juce::AudioDeviceManager &self, ::juce::AudioIODeviceTypeArray const **return$) noexcept {
...
::juce::AudioIODeviceType *cxx_juce$cxxbridge1$190$AudioDeviceManager$get_current_device_type_object(::cxx_juce::AudioDeviceManager const &self) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceManager$play_test_sound(::cxx_juce::AudioDeviceManager &self) noexcept {
  void (::cxx_juce::AudioDeviceManager::*play_test_sound$)() = &::cxx_juce::AudioDeviceManager::playTestSound;
  (self.*play_test_sound$)();
}

void cxx_juce$cxxbridge1$190$AudioDeviceManager$add_audio_callback(::cxx_juce::AudioDeviceManager &self, ::std::unique_ptr<::cxx_juce::AudioCallbackWrapper> const &callback) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceManager$remove_audio_callback(::cxx_juce::AudioDeviceManager &self, ::std::unique_ptr<::cxx_juce::AudioCallbackWrapper> const &callback) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceManager$add_audio_device_type(::cxx_juce::AudioDeviceManager &self, ::cxx_juce::BoxedAudioIODeviceType *device_type) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioDeviceManager$set_current_audio_device_type(::cxx_juce::AudioDeviceManager &self, ::rust::Str device_type) noexcept {
...
namespace audio_io_device {
extern "C" {
void cxx_juce$audio_io_device$cxxbridge1$190$get_device_name(::juce::AudioIODevice const &self_, ::rust::Str *return$) noexcept {
...
void cxx_juce$audio_io_device$cxxbridge1$190$get_device_type_name(::juce::AudioIODevice const &self_, ::rust::Str *return$) noexcept {
...
extern "C" {
double cxx_juce$cxxbridge1$190$AudioIODevice$get_current_sample_rate(::juce::AudioIODevice &self) noexcept {
...
::std::int32_t cxx_juce$cxxbridge1$190$AudioIODevice$get_current_buffer_size_samples(::juce::AudioIODevice &self) noexcept {
...
namespace audio_io_device {
extern "C" {
void cxx_juce$audio_io_device$cxxbridge1$190$get_available_sample_rates(::juce::AudioIODevice &self_, ::rust::Vec<double> *return$) noexcept {
...
void cxx_juce$audio_io_device$cxxbridge1$190$get_available_buffer_sizes(::juce::AudioIODevice &self_, ::rust::Vec<::std::size_t> *return$) noexcept {
...
::rust::repr::PtrLen cxx_juce$audio_io_device$cxxbridge1$190$open(::juce::AudioIODevice &self_, double sample_rate, ::std::size_t buffer_size) noexcept {
...
extern "C" {
void cxx_juce$cxxbridge1$190$AudioIODevice$close(::juce::AudioIODevice &self) noexcept {
...
namespace audio_io_device {
extern "C" {
::std::int32_t cxx_juce$audio_io_device$cxxbridge1$190$count_active_input_channels(::juce::AudioIODevice const &self_) noexcept {
...
::std::int32_t cxx_juce$audio_io_device$cxxbridge1$190$count_active_output_channels(::juce::AudioIODevice const &self_) noexcept {
...
namespace audio_io_device_type {
extern "C" {
void cxx_juce$audio_io_device_type$cxxbridge1$190$get_type_name(::juce::AudioIODeviceType const &self_, ::rust::String *return$) noexcept {
...
extern "C" {
void cxx_juce$cxxbridge1$190$AudioIODeviceType$scan_for_devices(::juce::AudioIODeviceType &self) noexcept {
...
namespace audio_io_device_type {
extern "C" {
void cxx_juce$audio_io_device_type$cxxbridge1$190$get_input_device_names(::juce::AudioIODeviceType const &self_, ::rust::Vec<::rust::String> *return$) noexcept {
...
void cxx_juce$audio_io_device_type$cxxbridge1$190$get_output_device_names(::juce::AudioIODeviceType const &self_, ::rust::Vec<::rust::String> *return$) noexcept {
...
::juce::AudioIODevice *cxx_juce$audio_io_device_type$cxxbridge1$190$new_device(::juce::AudioIODeviceType &self_, ::rust::Str input_device_name, ::rust::Str output_device_name) noexcept {
...
extern "C" {
::std::int32_t cxx_juce$cxxbridge1$190$AudioSampleBuffer$get_num_channels(::juce::AudioSampleBuffer const &self) noexcept {
...
::std::int32_t cxx_juce$cxxbridge1$190$AudioSampleBuffer$get_num_samples(::juce::AudioSampleBuffer const &self) noexcept {
  ::std::int32_t (::juce::AudioSampleBuffer::*get_num_samples$)() const = &::juce::AudioSampleBuffer::getNumSamples;
  return (self.*get_num_samples$)();
}

float const *cxx_juce$cxxbridge1$190$AudioSampleBuffer$get_read_pointer(::juce::AudioSampleBuffer const &self, ::std::int32_t channel) noexcept {
...
float *cxx_juce$cxxbridge1$190$AudioSampleBuffer$get_write_pointer(::juce::AudioSampleBuffer &self, ::std::int32_t channel) noexcept {
...
void cxx_juce$cxxbridge1$190$AudioSampleBuffer$clear(::juce::AudioSampleBuffer &self) noexcept {
...
extern "C" {
void cxx_juce$system_audio_volume$cxxbridge1$190$set_muted(bool muted) noexcept {
  void (*set_muted$)(bool) = ::cxx_juce::system_audio_volume::setMuted;
  set_muted$(muted);
}

bool cxx_juce$system_audio_volume$cxxbridge1$190$is_muted() noexcept {
  bool (*is_muted$)() = ::cxx_juce::system_audio_volume::isMuted;
  return is_muted$();
}

void cxx_juce$system_audio_volume$cxxbridge1$190$set_gain(float gain) noexcept {
  void (*set_gain$)(float) = ::cxx_juce::system_audio_volume::setGain;
  set_gain$(gain);
}

float cxx_juce$system_audio_volume$cxxbridge1$190$get_gain() noexcept {
...
extern "C" {
::juce::SingleThreadedIIRFilter *cxx_juce$iir_filter$cxxbridge1$190$create_iir_filter(::std::array<float, 5> *coefficients) noexcept {
...
namespace juce {
extern "C" {
void juce$cxxbridge1$190$SingleThreadedIIRFilter$process_samples(::juce::SingleThreadedIIRFilter &self, float *samples, ::std::int32_t num_samples) noexcept {
...
namespace iir_filter {
extern "C" {
void cxx_juce$iir_filter$cxxbridge1$190$make_low_pass(double sample_rate, double frequency, double q, ::std::array<float, 5> *return$) noexcept {
...
void cxx_juce$iir_filter$cxxbridge1$190$make_high_pass(double sample_rate, double frequency, double q, ::std::array<float, 5> *return$) noexcept {
...
void cxx_juce$iir_filter$cxxbridge1$190$make_notch_filter(double sample_rate, double frequency, double q, ::std::array<float, 5> *return$) noexcept {
...
::std::size_t BoxedAudioIODeviceCallback::layout::size() noexcept {
  return cxx_juce$cxxbridge1$190$BoxedAudioIODeviceCallback$operator$sizeof();
}

::std::size_t BoxedAudioIODeviceCallback::layout::align() noexcept {
  return cxx_juce$cxxbridge1$190$BoxedAudioIODeviceCallback$operator$alignof();
}
} // namespace cxx_juce

namespace audio_io_device_callback {
void aboutToStart(::cxx_juce::BoxedAudioIODeviceCallback &callback, ::juce::AudioIODevice &device) noexcept {
  audio_io_device_callback$cxxbridge1$190$about_to_start(callback, device);
}
...
void processBlock(::cxx_juce::BoxedAudioIODeviceCallback &callback, ::juce::AudioSampleBuffer const &input, ::juce::AudioSampleBuffer &output) noexcept {
  audio_io_device_callback$cxxbridge1$190$process_block(callback, input, output);
}

void stopped(::cxx_juce::BoxedAudioIODeviceCallback &callback) noexcept {
  audio_io_device_callback$cxxbridge1$190$stopped(callback);
}
} // namespace audio_io_device_callback

namespace cxx_juce {
::std::size_t BoxedAudioIODeviceType::layout::size() noexcept {
  return cxx_juce$cxxbridge1$190$BoxedAudioIODeviceType$operator$sizeof();
}

::std::size_t BoxedAudioIODeviceType::layout::align() noexcept {
  return cxx_juce$cxxbridge1$190$BoxedAudioIODeviceType$operator$alignof();
}
} // namespace cxx_juce
...
::rust::String name(::cxx_juce::BoxedAudioIODeviceType const &self_) noexcept {
  ...
  audio_io_device_type$cxxbridge1$190$name(self_, &return$.value);
  return ::std::move(return$.value);
}

void scanForDevices(::cxx_juce::BoxedAudioIODeviceType &self_) noexcept {
  audio_io_device_type$cxxbridge1$190$scan_for_devices(self_);
}
...
::rust::Vec<::rust::String> getDeviceNames(::cxx_juce::BoxedAudioIODeviceType const &self_, bool input) noexcept {
  ...
  audio_io_device_type$cxxbridge1$190$get_device_names(self_, input, &return$.value);
  return ::std::move(return$.value);
}
...
::cxx_juce::BoxedAudioIODevice *createDevice(::cxx_juce::BoxedAudioIODeviceType &self_, ::rust::Str input_device_name, ::rust::Str output_device_name) noexcept {
  return audio_io_device_type$cxxbridge1$190$create_device(self_, input_device_name, output_device_name);
}

void destroyDevice(::cxx_juce::BoxedAudioIODevice *self_) noexcept {
  audio_io_device_type$cxxbridge1$190$destroy_device(self_);
}
} // namespace audio_io_device_type

namespace cxx_juce {
::std::size_t BoxedAudioIODevice::layout::size() noexcept {
  return cxx_juce$cxxbridge1$190$BoxedAudioIODevice$operator$sizeof();
}

::std::size_t BoxedAudioIODevice::layout::align() noexcept {
  return cxx_juce$cxxbridge1$190$BoxedAudioIODevice$operator$alignof();
}
} // namespace cxx_juce
...
::rust::String deviceName(::cxx_juce::BoxedAudioIODevice const &self_) noexcept {
  ::rust::MaybeUninit<::rust::String> return$;
  audio_io_device$cxxbridge1$190$device_name(self_, &return$.value);
  return ::std::move(return$.value);
}

::rust::String typeName(::cxx_juce::BoxedAudioIODevice const &self_) noexcept {
  ::rust::MaybeUninit<::rust::String> return$;
  audio_io_device$cxxbridge1$190$device_type_name(self_, &return$.value);
  return ::std::move(return$.value);
}

double sampleRate(::cxx_juce::BoxedAudioIODevice &self_) noexcept {
  return audio_io_device$cxxbridge1$190$device_sample_rate(self_);
}

::std::size_t bufferSize(::cxx_juce::BoxedAudioIODevice &self_) noexcept {
  return audio_io_device$cxxbridge1$190$device_buffer_size(self_);
}

::rust::Vec<double> availableSampleRates(::cxx_juce::BoxedAudioIODevice &self_) noexcept {
  ::rust::MaybeUninit<::rust::Vec<double>> return$;
  audio_io_device$cxxbridge1$190$device_available_sample_rates(self_, &return$.value);
  return ::std::move(return$.value);
}
...
::rust::Vec<::std::size_t> availableBufferSizes(::cxx_juce::BoxedAudioIODevice &self_) noexcept {
  ...
  audio_io_device$cxxbridge1$190$device_available_buffer_sizes(self_, &return$.value);
  return ::std::move(return$.value);
}

::rust::String open(::cxx_juce::BoxedAudioIODevice &self_, double sample_rate, ::std::size_t buffer_size) noexcept {
  ::rust::MaybeUninit<::rust::String> return$;
  audio_io_device$cxxbridge1$190$device_open(self_, sample_rate, buffer_size, &return$.value);
  return ::std::move(return$.value);
}

void close(::cxx_juce::BoxedAudioIODevice &self_) noexcept {
  audio_io_device$cxxbridge1$190$device_close(self_);
}
} // namespace audio_io_device
